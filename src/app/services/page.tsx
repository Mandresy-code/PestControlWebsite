...
export const metadata: Metadata = {
  title: "Services",
  description:
    "Dératisation, désinsectisation, punaises de lit, désinfection, nuisibles volants, prévention & audit. Protocoles IPM adaptés à chaque contexte.",
};
    ...
    <>
      ...
      <div className="bg-navy-900 pt-[112px] pb-72">
        <div className="container-site">
          <p className="font-mono text-eyebrow uppercase tracking-widest text-signal-400 mb-16">
            Services
          </p>
