...
export const metadata: Metadata = {
  title: "Ressources",
  description:
    "Encyclopédie des nuisibles, guides pratiques IPM, conseils pour audits IFS/BRC. Tout pour mieux comprendre et prévenir.",
};
        ...
        <div className="grid sm:grid-cols-2 gap-32">
          {articles.map((article) => (
            <article key={article.slug} className="group flex flex-col gap-20 bg-paper rounded-lg p-32 shadow-1 hover:shadow-2 transition-shadow duration-standard ease-brand">
              ...
              <h2 className="text-h3 font-medium text-navy-900 leading-snug flex-1">
                {article.title}
              </h2>
