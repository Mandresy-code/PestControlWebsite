...
export default async function SecteurDetailPage(
  ...
  const relatedServices = services.filter((s) => sector.services.includes(s.slug));
    ...
    <>
      <div className="bg-navy-900 pt-[112px] pb-72">
        <div className="container-site">
          ...
          <span
            className={`inline-block font-mono text-eyebrow uppercase tracking-widest px-10 py-4 rounded-pill mb-20 ${
      ...
      <div className="bg-cream section-padding">
        <div className="container-site grid md:grid-cols-[1fr_320px] gap-72">
          <div>
            ...
            {/* Services adaptés */}
            <h2 className="text-h3 font-medium text-navy-900 mb-24">
            ...
            <div className="flex flex-col gap-16">
              {relatedServices.map((s) => (
                <Link
                  ...
                  className="group flex items-center justify-between gap-16 p-24 bg-paper rounded-lg border border-navy-900/8 hover:shadow-2 transition-shadow duration-standard ease-brand focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-signal-500/55"
                >
                  <div>
          ...
          <aside className="flex flex-col gap-24">
            <div className="bg-paper rounded-lg border border-navy-900/8 p-24 shadow-1">
              ...
              <p className="text-sm text-navy-600 mb-20">
                Décrivez votre situation en 2 minutes. Nous revenons vers vous sous 48 h.
              </p>
