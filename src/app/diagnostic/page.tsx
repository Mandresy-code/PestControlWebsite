    ...
    <div className="min-h-screen bg-cream pt-[72px]">
      <div className="container-site py-56 md:py-72">
        <div className="max-w-[680px] mx-auto">
          ...
          <h1 className="text-h1 font-medium text-navy-900 mb-16">
            Décrivez votre situation.
          </h1>
          <p className="text-body-lg text-navy-600 mb-40">
            Cinq questions. Nos techniciens analysent votre réponse et vous
            rappellent sous 48 h ouvrées. Pas de devis standard, pas de
            copier-coller.
          </p>
          <DiagnosticWizard />
        </div>
